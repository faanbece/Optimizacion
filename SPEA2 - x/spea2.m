...
% end
 ...
 disp('Objectivos       (Distancia) - (Tiempo) :');
    disp(['      Min = ', num2str(min(PFC(1,:))),' - ', num2str(min(PFC(2,:)))] );
    disp(['      Max = ', num2str(max(PFC(1,:))),' - ', num2str(max(PFC(2,:)))] );
    disp(['    Range = ', num2str(max(PFC(1,:))-min(PFC(1,:))),' - ', num2str(max(PFC(2,:))-min(PFC(2,:)))]);
    disp(['    St.D. = ', num2str(std(PFC(1,:))),' - ', num2str(std(PFC(2,:)))] );
    disp(['     Mean = ', num2str(mean(PFC(1,:))),' - ', num2str(mean(PFC(2,:)))] );
    disp(' ');
